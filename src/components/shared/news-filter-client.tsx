...
export function NewsFilterClient({
    ...
    (values: SearchFormValues) => {
      ...
      if (query) {
        ...
        if (currentAuthors.length)
          params.set("authors", currentAuthors.join(","));
  ...
  const removeFilter = (type: "categories" | "authors", id: string) => {
    const filtered =
      type === "categories"
  ...
  const hasActiveFilters =
    currentCategories.length > 0 || currentAuthors.length > 0;
                ...
                <div className="flex gap-2">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        size="lg"
                        className="h-12 relative hidden md:flex"
                        type="button"
                      >
                        Фильтры
                        {hasActiveFilters && (
                    ...
                    <DropdownMenuContent
                      className="w-60 max-h-96 overflow-y-auto"
                      align="end"
                    >
                  ...
                  <Sheet>
                    <SheetTrigger asChild>
                      <Button
                        size="lg"
                        className="h-12 md:hidden relative"
                        type="button"
                      >
                        Фильтры
                      </Button>
                    </SheetTrigger>
                    <SheetContent className="w-full sm:max-w-md p-6 space-y-6">
                      <SheetHeader>
                        <SheetTitle className="text-lg">Фильтры</SheetTitle>
                        <SheetDescription>
                          Выберите категории и авторов для фильтрации новостей
                        </SheetDescription>
                      </SheetHeader>
